...
-- ART MUSEUM AND SHOWROOM MANAGEMENT DATABASE
-- CREATED BY: VANSH DHAWAN (2K22/CO/489) && YASH JAIN (2K22/CO/511)
-- DATE: 23/05/2024
-- Project assigned by : Mr. Rohit Beniwal, Department of Computer Science and Engineering, Delhi Technological University (DTU)

-- Generation Time: May 22, 2024 at 10:35 PM
-- Database: `art_showroom`
...
--
-- Inserting data for table `contacts`
--
...
--
-- Inserting data for table `exhibition`
--
...
--
-- Inserting data for table `gallery`
--
